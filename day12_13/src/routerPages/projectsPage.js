...
<div class="allBlogShowArea projects">
    <div>
        <img src="/Users/wuzilin/Desktop/FE-primary-practice/day12/src/asets/manyData.png" alt="满屏数据">
        <div class="title">
            <p>User Experience Design Dashboard Hotel Management</p>
            <a href="">
                <img src="/Users/wuzilin/Desktop/FE-primary-practice/day12/src/asets/箭头_右上.png" alt=""
                    class="arrow">
            </a>
        </div>
        <p class="summary">
    ...
    <div>
        <img src="/Users/wuzilin/Desktop/FE-primary-practice/day12/src/asets/游行.png" alt="游行">
        <div class="title">
    ...
    <div class="sp-ceil">
        <img src="/Users/wuzilin/Desktop/FE-primary-practice/day12/src/asets/friendTalk.jpg" alt="朋友交谈">
        <div class="title">
    ...
    <div>
        <img src="/Users/wuzilin/Desktop/FE-primary-practice/day12/src/asets/somesymbol.png" alt="一些图标">
        <div class="title">
    ...
    <div>
        <img src="/Users/wuzilin/Desktop/FE-primary-practice/day12/src/asets/img1.png" alt="几张办公桌">
        <div class="title">
